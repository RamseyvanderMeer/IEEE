    ...
    return (
        <div className="signUp">
            ...
            <div className="signUp__body">
                <div class="signUp__body__grainger">
                    <div class="signUp__body__grainger__title">
                        Grainger Students:
                    </div>
                    <div class="signUp__body__grainger__body">
                ...
                <div class="signUp__body__nongrainger">
                    <div class="signUp__body__nongrainger__title">
                        Non-Grainger Students:
                    </div>
                    <div class="signUp__body__nongrainger__body">
